...
la incertidumbre en la espera nocturna.
...
No compilar. No modificar ningún otro archivo.
...
\begin{itemize}
	...
	implica esta ventaja de forma inherente \parencite{SHOW2024}.
	Objetivo: reducción de emisiones $\geq$\,50\,\% respecto al coche
	particular.
...
técnicos —esos los recoge el QFD (§\ref{sec:qfd})— sino el marco
...
\begin{itemize}
	...
	Rennes \parencite{AVENUE2023,SHOW2024}. El servicio no es
...
\begin{itemize}
	...
	nocturna plena a 2026 \parencite{SHOW2024}. La iluminación
	deficiente interrumpe la operación de los sensores. El
	horizonte 2035 cubre esta brecha, pero introduce
