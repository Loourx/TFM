...
\begin{itemize}
	...
	semiestructurada, mayo de 2026). Trazable a Insight~1 e Insight~3.
	Objetivo: tiempo de espera $\leq$\,15~min en el 100\,\% de los
	servicios post-turno.
...
\begin{itemize}
	...
	entrevista semiestructurada, mayo de 2026). Trazable a Insight~4.
	El CHUF o SERGAS debe actuar como socio clave del servicio, no solo
	como destinatario o regulador.
	Objetivo: acuerdo de gobernanza formalizado con el CHUF antes del
