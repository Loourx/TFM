...
mayor peso relativo (8,3\,\% cada uno) son: la seguridad física en el
trayecto, la viabilidad económica del desplazamiento, la seguridad percibida
para usuarias que viajan solas en franja nocturna, la cobertura interurbana
desde el municipio de origen y el acceso desde la zona de residencia mediante
nodo de intercambio \parencite{LouridoRegueira2026}.
...
En primer lugar, el \textbf{acceso sin reserva previa} mediante horario
fijo (objetivo: 0\,\% de trayectos que requieran gestión anticipada)
obtiene la puntuación técnica más alta de la matriz (5,0), con incidencia
directa sobre los requerimientos de flexibilidad y uso espontáneo del
servicio. Un sistema que exija reserva impone una barrera de acceso
incompatible con la variabilidad de los turnos sanitarios. Trazable a
Insight~4.

En segundo lugar, la \textbf{capacidad garantizada sin sobreocupación}
(objetivo: 0\,\% de usuarios sin plaza en la franja crítica post-turno)
comparte la segunda posición técnica (4,6) con el recorrido directo.
Es el parámetro determinante para la regularidad percibida: si el usuario
no puede confiar en obtener plaza, mantiene el vehículo propio como
alternativa de seguridad, lo que anula el efecto sustitución del servicio.
Trazable a Insight~1.

En tercer lugar, la \textbf{información en tiempo real del vehículo}
...
la incertidumbre durante la espera nocturna (4,2). Trazable a Insight~3.

Adicionalmente, la \textbf{disponibilidad de espacio de espera cubierto
e iluminado} en los nodos P+R (objetivo: 100\,\% de paradas con cubierta
e iluminación nocturna) presenta una importancia técnica agregada de 3,1,
por debajo de los tres anteriores, pero constituye el criterio de diseño
con mayor incidencia específica sobre los requerimientos de seguridad
percibida para usuarias que viajan solas. La percepción de seguridad en
franja nocturna no puede delegarse únicamente al vehículo si el espacio
de espera previo es inseguro. Trazable a Insight~5.
