...
Este trabajo de fin de máster propone el concepto de servicio de movilidad nocturna para el transporte nocturno de trabajadores de turno en el corredor del Complexo Hospitalario Universitario de Ferrol (\textsc{chuf}, A~Cabana) hacia las zonas residenciales de la ciudad, operando en la franja horaria comprendida entre las 22:00 y las 06:00~h; el horizonte temporal se determina en función de la tecnología seleccionada en la fase de diseño.
