...
servicio autónomo para el transporte nocturno de
...
\begin{enumerate}[label=\arabic*., leftmargin=*, noitemsep]
  ...
  \item Evaluar el estado de madurez de los shuttles autónomos en
...
múltiples casos. Por último, el horizonte 2035 implica que el concepto de servicio es prospectivo: la
tecnología \textsc{sae}~L4 no opera de manera madura comercialmente en Europa en la fecha
de redacción, y las proyecciones de limitaciones regulatoria y tecnológica
están sujetas a incertidumbre inherente.
