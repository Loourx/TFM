...
30~min. Resultado: el problema no es solo ausencia de servicio, sino
...
este parámetro informa los requisitos del servicio en §~4.1.
...
Informan directamente el QFD de §~4.1.
...
no en parada convencional de acera. Este criterio se desarrolla en §~4.1.
