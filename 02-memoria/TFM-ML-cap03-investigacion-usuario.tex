...
El mapa de empatía sintetiza los patrones de comportamiento,
pensamiento y emoción del usuario primario identificado en la
investigación: enfermera o~\acs{TCAE} de turno nocturno
(22:00--08:00), mujer, entre 46 y 55~años, residente en municipio
distinto al~\acs{CHUF}~\parencite{LouridoRegueira2026}. La
construcción del mapa se basa exclusivamente en datos primarios:
las 167~respuestas válidas de la encuesta y los fragmentos
codificados de la entrevista en profundidad (Participante~1,
entrevista semiestructurada, 22~de mayo de 2026).
...
espontánea la demanda de un transporte gestionado: «Estaría bien que
a los trabajadores de hospitales se nos pusiera un transporte para
llevarnos al hospital y recogernos en un punto y de ahí para
casa»~\parencite{LouridoRegueira2026}. En la entrevista, la usuaria
identifica el servicio de autobús como «también deficiente» en turnos
atípicos y señala que la aplicación Moovit no es fiable en festivos
ni fines de semana (Participante~1, entrevista semiestructurada,
22~de mayo de 2026).

\textbf{Hace.} El 52,7\,\% de la muestra conduce con sueño o fatiga
varias veces a la semana~\parencite{LouridoRegueira2026}. El 61,1\,\%
tiene dificultades de aparcamiento con esa misma frecuencia. El
vehículo propio es la alternativa modal predominante en la franja
nocturna por ausencia de oferta pública.

\textbf{Piensa y siente.} El índice de gravedad de la fatiga al
volante alcanza 60,2 sobre~100 en la encuesta~\parencite{LouridoRegueira2026}.
El 90,8\,\% de las mujeres de la muestra presenta riesgo de fatiga
al volante con frecuencia igual o superior a varias veces al mes,
frente al 53,8\,\% de los hombres. El impacto laboral concreto
(retrasos, bajas, cambios de turno) lo declara el 25,7\,\% de las
encuestadas.

\textbf{Ve y oye.} El hospital está ubicado en~A Cabana, periferia
de Ferrol, sin servicio de transporte público en la franja
22:00--06:00~\parencite{Alsaferrol2024horarios,RenfeCercaniasFerrol2026}.
El 52,1\,\% de la muestra no dispone de cobertura fiable de transporte
público para llegar al trabajo~\parencite{LouridoRegueira2026}. En la
entrevista, la usuaria describe el contexto: «El primer servicio llega
con 30~min de retraso respecto al cambio de turno» (Participante~1,
entrevista semiestructurada, 22~de mayo de 2026).

\textbf{Dolores y ganancias.} Los dolores de mayor peso son la fatiga
al volante post-turno, el coste y la escasez de aparcamiento en el
hospital, y la ausencia de alternativa de transporte público. Las
ganancias esperadas son llegar a casa sin conducir en estado de
fatiga, eliminar el gasto de aparcamiento y disponer de un trayecto
sincronizado con el cambio de turno sin necesidad de planificación
individual. Estos patrones convergen con los cinco insights de diseño
establecidos en el capítulo~\ref{cap:criterios}.
