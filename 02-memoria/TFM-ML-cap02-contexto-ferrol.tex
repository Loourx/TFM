...
\fuentependiente{referencia sobre umbrales de demanda
en transporte nocturno urbano}.
...
\fuentependiente{referencia sobre implementaciones DRT
nocturno en ciudades medias europeas}.
...
\fuentependiente{referencia sobre modelos de shuttle
institucional en entorno sanitario o similar}.
...
\fuentependiente{referencia SHOW H2020 o AVENUE H2020}.
...
empleadora como beneficio social \fuentependiente{referencia
sobre modelos de transporte institucional para personal
sanitario}.
...
Ferrol es un municipio gallego situado en el noroeste de España de 64.218~habitantes según el Padrón Municipal a 1~de enero de 2024 \cite{INE2024Ferrol}.

El \ac{CHUF}, que integra los hospitales Arquitecto Marcide, Naval y Profesor Novoa Santos, se ubica en la Avenida de la Residencia s/n, Ferrol \cite{Sanidad2024CHUF}, fuera de la cuadrícula urbana central de la ciudad, a una distancia estimada de entre 2 y~4\,km del centro urbano \fuentependiente{verificar con cartografía oficial IDE Galicia o Catastro}.
